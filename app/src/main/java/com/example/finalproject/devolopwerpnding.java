...
public class devolopwerpnding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(devolopwerpnding.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(devolopwerpnding.this, detailsdevoloper.class)
