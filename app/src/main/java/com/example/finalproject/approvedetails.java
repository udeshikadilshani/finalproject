...
public class approvedetails extends AppCompatActivity {
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.getExtras()!=null) {
            ...
            Glide.with(approvedetails.this).load(photoUri).into(image);
                    ...
                    dbroot.collection(category)
                            ...
                            .addOnSuccessListener(new OnSuccessListener() {
                                ...
                                public void onSuccess(Object o) {
                                    Toast.makeText(approvedetails.this, "Approved successfully!", Toast.LENGTH_LONG).show();
                                }
                            });
                }
            });
                ...
                public void onClick(View view) {
                    ...
                    dbroot.collection(category)
                            ...
                            .addOnSuccessListener(new OnSuccessListener() {
                                @Override
                                public void onSuccess(Object o) {
                                    Toast.makeText(approvedetails.this, "Decline successfully!", Toast.LENGTH_LONG).show();
                                }
                            });
                }
            });
