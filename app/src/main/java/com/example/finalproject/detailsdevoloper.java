...
public class detailsdevoloper extends AppCompatActivity {
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailsdevoloper);
        ...
        if(intent.getExtras()!=null) {
            ...
            Glide.with(detailsdevoloper.this).load(photoUri).into(image);
                    ...
                    dbroot.collection(category)
                            ...
                            .addOnSuccessListener(new OnSuccessListener() {
                                ...
                                public void onSuccess(Object o) {
                                    Toast.makeText(detailsdevoloper.this, "Approved successfully!", Toast.LENGTH_LONG).show();
                                }
                            });
                }
            });
                ...
                public void onClick(View view) {
                    ...
                    dbroot.collection(category)
                            ...
                            .addOnSuccessListener(new OnSuccessListener() {
                                @Override
                                public void onSuccess(Object o) {
                                    Toast.makeText(detailsdevoloper.this, "Decline successfully!", Toast.LENGTH_LONG).show();
                                }
                            });
                }
            });
