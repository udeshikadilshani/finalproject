...
public class grideviwedevoloper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_grideviwedevoloper);
        firebaseFirestore = FirebaseFirestore.getInstance();
        products = new ArrayList<>();
        docId = new ArrayList<>();
        productView = (GridView) findViewById(R.id.approvegrid);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(grideviwedevoloper.this, products);

                Product p1 = (Product) adapter.getItem(i);
                Intent intent = new Intent(grideviwedevoloper.this, approvedetails.class)
