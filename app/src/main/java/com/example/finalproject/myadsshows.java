...
public class myadsshows extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myadsshows);

        firebaseFirestore = FirebaseFirestore.getInstance();
        products= new ArrayList<>();
        docId= new ArrayList<>();
        productView=(GridView) findViewById(R.id.myadsshows);
        additem();
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(myadsshows.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(myadsshows.this, detelsads.class)
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()) {
                    for (QueryDocumentSnapshot snapshot : task.getResult()){
                        ...
                        if(product.getUserId().equals("admin")) {
                            if(snapshot.get("userId").toString().trim().equals("admin")) {
